...
export type InputProps = ComboboxProps &
  Omit<ComponentPropsWithoutRef<'input'>, keyof ComboboxProps>;

export const Combobox = forwardRef<ElementRef<'input'>, InputProps>(
  (
    {
      disabled,
      errorMessage,
