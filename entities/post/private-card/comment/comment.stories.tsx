import { getMockPublicPostComments as getMockPublicPC } from '@/entities/post/public-card/comment/comment.stories';
import { Meta, StoryObj } from '@storybook/react';

import { PrivatePostComment, PrivatePostCommentType } from './comment';
...
const meta = {
  ...
  tags: ['autodocs'],
  title: 'ENTITIES/post/PrivateComment',
